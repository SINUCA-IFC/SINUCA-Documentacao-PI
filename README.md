...
RF001 - O sistema deve manter delegação.
RF002 - O sistema deve manter membro.
RF003 - O sistema deve manter resposta.
RF004 - O sistema deve manter administrador.
RF005 - O sistema deve manter postagem.
RF006 - O sistema deve manter tarefa.sss
RF007 - O sistema deve manter organizador.
RF008 - O sistema deve manter avaliação.
RF009 - O sistema deve manter avaliador.
RF010 - O sistema deve manter cronograma.
RF011 - O sistema deve manter itens do cronograma.
RF012 - O sistema deve controlar acesso a funcionalidades com base no tipo de usuário.
RF013 -  O sistema deve permitir a filtragem de postagem por categoria.
RF014 - O sistema deve permitir a atribuição de tarefas a membros.
